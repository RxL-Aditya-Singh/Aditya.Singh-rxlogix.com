...
<html>
<head>
    <asset:stylesheet src="topicShow/topicShow.css"/>
...
<body>
    ...
    <div class="border border-dark" style="margin: 8px">
        <nav class="navbar navbar-dark bg-dark">
            ...
            <a href="#"><i class="fa fa-link fa-lg" aria-hidden="true"></i></a>
            <a href="#"><i class="fa fa-file-o fa-lg" aria-hidden="true"></i></a>
            <a href="#"><i class="fa fa-fw fa-user fa-lg"></i></a>
